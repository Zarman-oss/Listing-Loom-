...
//         height={0}
//         width={0}
//         className="w-full h-auto lg:w-10/12 lg:h-auto" // Updated for larger images on large screens
//       />
//       <div className="p-2">
  ...
  return (
    <div className="rounded-xl shadow-md relative lg:max-w-sm">
      <Image
        ...
        height={0}
        width={0}
        className="w-full h-auto lg:w-full lg:h-48" // Updated for smaller image size on large screens
      />
      <div className="p-2">
        <div className="text-left md:text-center lg:text-left mb-1">
          <div className="text-gray-600">{property.type}</div>
